...
// Package forkid implements EIP-2124 (https://eipscrestchain.io/EIPS/eip-2124).
package forkid
...
// NewID calculates the Crestchain fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Crestchain fork ID from an existing chain instance.
