...
// It can be used for testing that restart gcrestnormally.
...
// It can be used for testing that restart gcrestafter the crash.
...
// Tests a gcrestrestart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a gcrestwas crashed and restarts with a broken snapshot. In this case the
...
// Tests a gcrestwas crashed and restarts with a broken snapshot. In this case
...
// Tests a gcrestwas running with snapshot enabled. Then restarts without
...
// Tests the gcrestwas running with snapshot enabled and resetHead is applied.
...
// Tests the gcrestwas running with a complete snapshot and then imports a few
