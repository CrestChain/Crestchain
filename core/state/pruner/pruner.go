...
pruning. Remember don't start the gcrestwithout deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gcrest snapshot prune-state --help" for more details.
`
