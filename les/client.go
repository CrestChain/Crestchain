...
// Package les implements the Light Crestchain Subprotocol.
package les
...
import (
	...
	"github.com/CrestChain/go-crest/les/downloader"
	"github.com/CrestChain/go-crest/les/vflux"
	vfc "github.com/CrestChain/go-crest/les/vflux/client"
	"github.com/CrestChain/go-crest/light"
	...
	"github.com/CrestChain/go-crest/p2p/enr"
...
// APIs returns the collection of RPC services the crestchain package offers.
...
// light crestchain protocol implementation.
...
func (s *LightEthereum) Stop() error {
	...
	s.lesDb.Close()
	s.wg.Wait()
	log.Info("Light crestchain stopped")
	return nil
}
