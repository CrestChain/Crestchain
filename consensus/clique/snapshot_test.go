...
// mapped from textual names used in the tests below to actual Crestchain private
...
// address retrieves the Crestchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Crestchain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/CrestChain/go-crest/issues/17593). Whilst this
