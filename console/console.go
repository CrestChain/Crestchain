...
import (
	...
	"github.com/CrestChain/go-crest/internal/jsre/deps"
	"github.com/CrestChain/go-crest/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Crestchain requests through
...
// Welcome show summary of current gcrestinstance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the gcrestJavaScript console!\n\n"

	// Print some generic gcrestmetadata
