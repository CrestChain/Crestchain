...
import (
	...
	"github.com/CrestChain/go-crest/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Crestchain service within
	...
	if err != nil {
		t.Fatalf("failed to register Crestchain protocol: %v", err)
	}
