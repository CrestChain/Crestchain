...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gcrest.ipc", false, filepath.Join(os.TempDir(), "gcrest.ipc")},
		{"data", "gcrest.ipc", false, "data/gcrest.ipc"},
		{"data", "./gcrest.ipc", false, "./gcrest.ipc"},
		{"data", "/gcrest.ipc", false, "/gcrest.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gcrest.ipc", true, `\\.\pipe\gcrest.ipc`},
		{"data", "gcrest.ipc", true, `\\.\pipe\gcrest.ipc`},
		{"data", `\\.\pipe\gcrest.ipc`, true, `\\.\pipe\gcrest.ipc`},
	}
