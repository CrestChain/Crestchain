...
import (
	...
	"github.com/CrestChain/go-crest/accounts/external"
	"github.com/CrestChain/go-crest/accounts/keystore"
	"github.com/CrestChain/go-crest/accounts/scwallet"
	"github.com/CrestChain/go-crest/accounts/usbwallet"
	"github.com/CrestChain/go-crest/cmd/utils"
	"github.com/CrestChain/go-crest/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gcrest.ipc"
	return cfg
}

// makeConfigNode loads gcrest configuration and creates a blank node instance.
...
// makeFullNode loads gcrest configuration and creates the Crestchain backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the Crestchain Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
