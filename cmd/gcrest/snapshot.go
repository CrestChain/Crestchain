...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale crestchain state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
gcrest snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gcrest snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
gcrest snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
gcrest snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gcrest dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gcrest dump', but uses the snapshots
