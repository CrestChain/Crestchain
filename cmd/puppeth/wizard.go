...
type wizard struct {
	...
	services map[string][]string   // Crestchain services known to be running on servers
...
// converts it to an Crestchain address. If an empty line is entered, the default
// value is returned.
