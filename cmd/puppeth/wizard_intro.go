...
// setting up a new or managing an existing Crestchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Crestchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Crestchain network down to  |")
	...
	log.Info("Administering Crestchain network", "name", w.network)
