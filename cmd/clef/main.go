...
import (
	...
	"github.com/CrestChain/go-crest/signer/core"
	"github.com/CrestChain/go-crest/signer/core/apitypes"
	"github.com/CrestChain/go-crest/signer/fourbyte"
	"github.com/CrestChain/go-crest/signer/rules"
	"github.com/CrestChain/go-crest/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Crestchain account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/CrestChain/go-crest/issues/20123
