...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Crestchain protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Crestchain protocol to
...
// Node represents a gcrestCrestchain node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new gcrestnode.
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the Crestchain protocol if requested
...
// GetEthereumClient retrieves a client to access the Crestchain subsystem.
