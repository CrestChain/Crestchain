...
// Package graphql provides a GraphQL interface to Crestchain node data.
package graphql
...
// Account represents an Crestchain account at a particular block.
type Account struct {
...
// Transaction represents an Crestchain transaction.
...
// Block represents an Crestchain block.
...
type CallData struct {
	From                 *common.Address // The Crestchain address the call is from.
	To                   *common.Address // The Crestchain address the call is to.
