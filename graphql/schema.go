...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Crestchain address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Crestchain account at a particular block.
    type Account {
    ...
    # Log is an Crestchain event log.
    type Log {
    ...
    # Transaction is an Crestchain transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Crestchain account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Crestchain account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Crestchain block by number or by hash. If neither is
