...
import (
	...
	chainParams "github.com/CrestChain/go-crest/params"
	"github.com/CrestChain/go-crest/rpc"
	"github.com/CrestChain/go-crest/trie"
)

// Register adds catalyst APIs to the node.
func Register(stack *node.Node, backend *eth.Crestchain) error {
...
func newConsensusAPI(eth *eth.Crestchain) *consensusAPI {
