...
import (
	...
	"github.com/CrestChain/go-crest/trie"
)

// PublicEthereumAPI provides an API to access Crestchain full node-related
// information.
type PublicEthereumAPI struct {
	e *Crestchain
}

// NewPublicEthereumAPI creates a new Crestchain protocol API for full nodes.
func NewPublicEthereumAPI(e *Crestchain) *PublicEthereumAPI {
...
func NewPublicMinerAPI(e *Crestchain) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Crestchain) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Crestchain full node-related APIs
...
// admin methods of the Crestchain service.
func NewPrivateAdminAPI(eth *Crestchain) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Crestchain full node APIs exposed
...
// related public debug methods of the Crestchain service.
func NewPublicDebugAPI(eth *Crestchain) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Crestchain full node APIs exposed over
...
// private debug methods of the Crestchain service.
func NewPrivateDebugAPI(eth *Crestchain) *PrivateDebugAPI {
