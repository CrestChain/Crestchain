...
import (
	...
	"github.com/CrestChain/go-crest/p2p/msgrate"
...
// Syncer is an Crestchain account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Crestchain state over the
// snap protocol.
