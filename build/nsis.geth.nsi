...
# 1. install gcrest for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gcrest
# 5. create gcrest, attach and uninstall start menu entries
...
!define GROUPNAME "Crestchain"
!define APPNAME "Geth"
!define DESCRIPTION "Official Go implementation of the Crestchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gcrest is installed global
