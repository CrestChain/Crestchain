Name "gcrest ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/CrestChain/go-crest/issues"
!define UPDATEURL "https://github.com/CrestChain/go-crest/releases"
!define ABOUTURL "https://github.com/CrestChain/go-crest#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gcrest.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gcrest.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "gcrestincoming peers (TCP:30307)"
  SimpleFC::AdvRemoveRule "gcrestoutgoing peers (TCP:30307)"
  SimpleFC::AdvRemoveRule "gcrestUDP discovery (UDP:30307)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "gcrestincoming peers (TCP:30307)" ""  6 1 1 2147483647 1 "$INSTDIR\gcrest.exe" "" "" "Crestchain" 30307 "" "" ""
  SimpleFC::AdvAddRule "gcrestoutgoing peers (TCP:30307)" ""  6 2 1 2147483647 1 "$INSTDIR\gcrest.exe" "" "" "Crestchain" "" 30307 "" ""
  SimpleFC::AdvAddRule "gcrestUDP discovery (UDP:30307)" "" 17 2 1 2147483647 1 "$INSTDIR\gcrest.exe" "" "" "Crestchain" "" 30307 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gcrest.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gcrest.ipc"
